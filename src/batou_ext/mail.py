...
class PostfixRelay(batou.component.Component):
    ...
    def configure(self):
        ...
        self += batou.lib.file.File('/etc/local/postfix/main.cf',
                                    content=dedent(
                                        self.expand("""
...
class Mailhog(batou.component.Component):
    ...
    def configure(self):
        ...
        self += batou.lib.file.File("mailhog",
                                    mode=0o755,
                                    content=dedent(f"""\
                #!/bin/sh
                set -e
        ...
        self += batou.lib.file.File(self.docroot,
                                    ensure="directory",
                                    leading=True)
        ...
        self += batou.lib.service.Service("mailhog",
                                          systemd=dict(Restart="always",
                                                       Type="simple"))
